defmodule FlightTracker.MessageBroadcaster do
  ...
  @doc """
  Injects a raw message that is not a cloud event
  """
  def boradcast_message(message) do
  ...
  defp to_event(%{
      ...
      message: %{heading: _hdg, ground_speed: _gs, vertical_rate: _vr, vertical_rate_source: vrs} = msg
    }) do
    source =
      case vrs do
