...
defmodule LunarFrontiers.App.Projectors.Building do
  alias LunarFrontiers.App.Events.BuildingSpawned.V2
  ...
  def handle(
    ...
    Redix.command(:projections, ["SADD", player_buildings_key(player_id), site_id])
  ...
  defp player_buildings_key(player_id) do
    "buildings:#{player_id}"
  end
